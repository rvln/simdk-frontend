    ...
    <main className="flex-1 lg:p-10 px-6 py-6 pb-20">
      ...
      <header className="mb-10 max-w-6xl">
        ...
        <p className="text-on-surface-variant font-public-sans text-lg">
          Selamat datang kembali, Bapak Ahmad. Pantau aktivitas panti hari ini secara real-time.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-6xl">
        ...
        <GlassContainer className="p-8 flex flex-col gap-4 group hover:-translate-y-1 transition-transform duration-300 shadow-ambient">
          ...
          <div>
            ...
            <h2 className="text-5xl font-black text-primary mb-2 font-sans">5</h2>
            <p className="text-on-surface-variant text-sm font-sans font-light">Pengajuan jadwal baru.</p>
          </div>
        </GlassContainer>
        ...
        <div className="bg-gradient-to-br from-primary to-primary-container p-8 rounded-xl flex flex-col gap-4 text-white group hover:-translate-y-1 transition-transform duration-300 shadow-ambient border-none">
          ...
          <div>
            ...
            <h2 className="text-5xl font-black mb-2 font-sans text-white">12</h2>
            <p className="opacity-90 text-sm font-sans font-light">Resi donasi fisik pending.</p>
          </div>
        </div>
        ...
        <GlassContainer className="p-8 flex flex-col gap-4 group hover:-translate-y-1 transition-transform duration-300 shadow-ambient">
          ...
          <div>
            <p className="font-public-sans text-sm font-semibold text-on-surface-variant uppercase tracking-widest mb-1">
              Kapasitas Sesi Berjalan
            </p>
            <h2 className="text-2xl font-bold text-tertiary mb-2 font-sans">Sisa 8 Slot Terbuka</h2>
            <p className="text-on-surface-variant text-sm font-sans font-light">Dari total 20 kuota harian.</p>
          </div>
        </GlassContainer>
      </section>
      ...
      <div className="flex flex-col lg:flex-row gap-8 max-w-6xl">
        ...
        <section className="lg:w-[60%]">
          <GlassContainer className="p-8 shadow-ambient flex flex-col h-full">
            <div className="flex justify-between items-center mb-8">
              <h3 className="text-2xl font-bold text-primary font-sans">Agenda Kunjungan Hari Ini</h3>
            ...
            <div className="space-y-4 flex-1">
              <div className="flex items-center gap-6 p-6 bg-surface-container-low rounded-xl group hover:bg-surface-variant transition-colors cursor-pointer border-none shadow-none">
                <div className="flex flex-col items-center justify-center bg-surface-container-lowest rounded-lg px-4 py-2 shadow-sm min-w-[80px]">
                  <span className="text-primary font-black text-xl font-sans">13:00</span>
                  <span className="text-[10px] font-public-sans font-bold text-on-surface-variant uppercase">WIB</span>
                </div>
                <div className="flex-1">
                  <h4 className="font-bold text-on-surface text-lg font-sans">BEM Universitas X</h4>
              ...
              <div className="flex items-center gap-6 p-6 bg-surface-container-low rounded-xl group hover:bg-surface-variant transition-colors cursor-pointer border-none shadow-none">
                <div className="flex flex-col items-center justify-center bg-surface-container-lowest rounded-lg px-4 py-2 shadow-sm min-w-[80px]">
                  <span className="text-primary font-black text-xl font-sans">15:30</span>
                  <span className="text-[10px] font-public-sans font-bold text-on-surface-variant uppercase">WIB</span>
                </div>
                <div className="flex-1">
                  <h4 className="font-bold text-on-surface text-lg font-sans">Keluarga Budi</h4>
                  <p className="text-on-surface-variant font-public-sans text-sm flex items-center gap-1 mt-1">
        ...
        <section className="lg:w-[40%]">
          <GlassContainer className="p-8 shadow-ambient flex flex-col h-full">
            <h3 className="text-2xl font-bold text-primary mb-8 font-sans">Log Aktivitas</h3>
              ...
              <div className="space-y-8 relative">
                ...
                <div className="flex gap-6 items-start relative">
                  ...
                  <div className="flex-1 pt-1">
                    <p className="font-bold text-sm text-on-surface font-sans">Donasi Dana Rp 500.000</p>
                    <p className="text-tertiary font-public-sans text-xs font-bold uppercase tracking-widest mt-1">Sukses</p>
                    <span className="text-[10px] text-on-surface-variant uppercase font-public-sans mt-2 block">10 Menit yang lalu</span>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start relative">
                  <div className="w-7 h-7 rounded-full bg-primary flex items-center justify-center text-white ring-4 ring-surface-container-lowest z-10 flex-shrink-0">
                    <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>inventory</span>
                  </div>
                  <div className="flex-1 pt-1">
                    <p className="font-bold text-sm text-on-surface font-sans">Sepatu Anak (Check-in Selesai)</p>
                    <p className="text-primary font-public-sans text-xs font-bold uppercase tracking-widest mt-1">Logistik</p>
                    <span className="text-[10px] text-on-surface-variant uppercase font-public-sans mt-2 block">45 Menit yang lalu</span>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start relative">
                  ...
                  <div className="flex-1 pt-1">
                    <p className="font-bold text-sm text-on-surface font-sans">Update Profil Anak Panti</p>
                    <p className="text-on-surface-variant font-public-sans text-xs font-bold uppercase tracking-widest mt-1">Database</p>
                    <span className="text-[10px] text-on-surface-variant uppercase font-public-sans mt-2 block">2 Jam yang lalu</span>
                  </div>
                </div>
              </div>
            </div>
